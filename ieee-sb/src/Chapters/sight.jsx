...
const sightMembersData = [
  ...
  },
  {
    ...
    role: "Secretary - IEEE SIGHT Chapter",
    department: "Electronics & Communication",
...
const SIGHT = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-orange-50 to-white py-24 px-6">
      ...
      <div className="text-center mb-20">
        ...
        <div className="w-28 h-1 bg-orange-500 mx-auto mt-6 rounded-full"></div>
      </div>

      {/* ===== Members Grid ===== */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14 justify-items-center">
        {sightMembersData.map((member, index) => (
          <motion.div
            key={index}
          ...
          >
            {/* Accent Bar */}
            <div className="h-2 bg-orange-500 rounded-t-2xl"></div>
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-orange-600 font-medium mt-2 text-sm uppercase tracking-wide">
                {member.role}
              </p>

              <div className="mt-4 inline-block bg-orange-50 text-orange-600 text-xs px-4 py-2 rounded-full">
                {member.department}
              </div>
