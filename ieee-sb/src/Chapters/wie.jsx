...
const Wie = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-purple-50 to-white py-24 px-6">
      ...
      <div className="text-center mb-20">
        ...
        <div className="w-28 h-1 bg-purple-600 mx-auto mt-6 rounded-full"></div>
      </div>
