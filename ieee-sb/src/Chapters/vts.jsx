...
const VTS = () => {
  return (
    <div className="min-h-screen bg-gradient-to-b from-white via-green-50 to-white py-24 px-6">
      ...
      <div className="text-center mb-20">
        ...
        >
          IEEE Vehicular Technology Society Chapter
        </motion.h1>
        ...
        <div className="w-28 h-1 bg-green-600 mx-auto mt-6 rounded-full"></div>
      </div>

      {/* ===== Members Grid ===== */}
      <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-14 justify-items-center">
        {vtsMembersData.map((member, index) => (
          <motion.div
            key={index}
          ...
          >
            {/* Accent Bar */}
            <div className="h-2 bg-green-600 rounded-t-2xl"></div>
            ...
            <div className="p-10 text-center">
              ...
              <p className="text-green-700 font-medium mt-2 text-sm uppercase tracking-wide">
                {member.role}
              </p>

              <div className="mt-4 inline-block bg-green-50 text-green-700 text-xs px-4 py-2 rounded-full">
                {member.department}
              </div>
